...
// RUN: %cpp-to-llvm %s | %capi-opt -inst-api="gnu" -inst-filter="$(dirname %s)/basic.filt" -S | opt -inline -post-inline-ee-instrument -S | FileCheck %s -check-prefix=CHECK-INST


// CHECK: define dso_local i32 @_Z3bari(i32 %0) local_unnamed_addr #[[#BARATTR:]]
// CHECK: define dso_local i32 @_Z3fooi(i32 %0) local_unnamed_addr #[[#FOOMAINATTR:]]
// CHECK: define dso_local i32 @main(i32 %0, i8** nocapture readnone %1) local_unnamed_addr #[[#FOOMAINATTR]]
...
// CHECK-INST: define dso_local i32 @_Z3bari(i32 %0)
...
// CHECK-INST: define dso_local i32 @_Z3fooi(i32 %0)
...
// CHECK-INST: define dso_local i32 @main(i32 %0, i8** %1)
// CHECK-INST: call void @__cyg_profile_func_enter
// CHECK-INST: call void @__cyg_profile_func_exit
